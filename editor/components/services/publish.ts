...
import { parse } from "../../publisher/parser";
import { Project } from "./useProject";

export async function selectPublishedFolder(project: Project, source: string, onError: (msg?: string) => void) {
  try {
    ...
    const intfic: iFictionRecord = project.record;
    console.log({ intfic });

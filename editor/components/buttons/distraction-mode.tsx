const hushCSS = `
mirrorway-logo { visibility: hidden; }
mobile-editor  { visibility: hidden; }
...
hushStyle.id = "hushmode";
hushStyle.innerHTML = hushCSS;
document.head.appendChild(hushStyle);
hushStyle.disabled = true;

function toggleHushMode() {
  hushStyle.disabled = !hushStyle.disabled;
}

export function DistractionButton() {
  return (
    <distraction-button>
      <button type="button" className="notbutton" aria-label="unbothered mode" title="unbothered mode" onClick={toggleHushMode}>
        <svg fill="#000000" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 32 32">
          <path
            d="M23.61,31h-0.72c0-3.114-2.104-5.849-5.115-6.65c-0.145-0.038-0.25-0.162-0.266-0.312
